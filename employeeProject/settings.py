...
SECRET_KEY = 'django-insecure-awqm9xkif@tm_ki#k^)ptr^v7!d(s5+jzbeno)7v&25e3-f(*@'
...
#STATICFILES_DIRS = [
    #BASE_DIR / 'static',
#To learn more about semantic completion, see https://tabnine.com/semantic.   '/var/www/static/',
#]
